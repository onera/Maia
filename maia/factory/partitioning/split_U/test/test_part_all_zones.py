...
def test_set_mpart_reordering():
  keep_alive = []
  reorder_options = {'cell_renum_method' : 'CUTHILL', 'face_renum_method' : 'LEXICOGRAPHIC', 'edge_renum_method' : 'NONE', 'vtx_renum_method' : 'SORT_INT_EXT'}
...
"""
  ...
  partU.set_mpart_dmeshes(mpart, dzones, comm, True, keep_alive)
