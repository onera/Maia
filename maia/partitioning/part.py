...
def partition_by_elt(dist_tree, comm, split_method):
  ...
  """
  zones = I.getZones(dist_tree)
  if len(zones)!=1: raise NotImplementedError

  dmesh_nodal = cgns_dist_zone_to_pdm_dmesh_nodal(zones[0],comm)

  n_part = 1
  PDM.pdm_run_ppart_zone_nodal(dmesh_nodal,split_method,n_part,comm)

  #n_part = 1
  #multi_part = PDM.MultiPartZoneNodal()
  #multi_part.run_ppart_zone_nodal(dmesh_nodal,split_method,n_part,comm)

  ## TODO none of this matter, just here for a PDM.MultiPart object
  #n_zone = 1
  #n_part_per_zone = 1
