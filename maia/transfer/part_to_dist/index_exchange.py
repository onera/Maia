...
def create_part_pl_gnum(dist_zone: CGNSDistTree, 
  ...
  GI = EP.GlobalIndexer(blk_distri_f, [gn-1 for gn in ln_to_gn_list], comm)
...
def part_pl_to_dist_pl(dist_zone: CGNSDistTree,
  ...
  GI = EP.GlobalIndexer(distri, [gn-1 for gn in ln_to_gn_list], comm)
...
def part_elt_to_dist_elt(dist_zone, part_zones, elem_name, comm):
  ...
  GI = EP.GlobalIndexer(distri_elt, [gn-1 for gn in elt_gnum_l], comm)
...
def part_ngon_to_dist_ngon(dist_zone, part_zones, elem_name, comm):
  ...
  GI = EP.GlobalIndexer(distri, [e-1 for e in elt_gnum_l], comm)
  n_faceTot = distri[-1]
...
def part_nface_to_dist_nface(dist_zone, part_zones, elem_name, ngon_name, comm):
  ...
  GI = EP.GlobalIndexer(distri_cell, [gn-1 for gn in cell_gnum_l], comm)
