...
def index_to_ij_from_loc(idx: Union[int, ArrayLike],
                         loc: str, n_vtx: List[int]) -> Tuple[Union[int, ArrayLike], Union[int, ArrayLike]]:
...
def faceiIndex_to_ijk(idx: Union[int, ArrayLike], 
                      n_cell: Union[List[int], Tuple[int, ...]],
...
def ijk_to_facejIndex(i: Union[int, ArrayLike], 
                      j: Union[int, ArrayLike], 
                      k: Union[int, ArrayLike], 
...
def facejIndex_to_ijk(
  idx: Union[int, ArrayLike],
  n_cell: Union[List[int], Tuple[int, ...]], 
  n_vtx: Union[List[int], Tuple[int, ...]]
) -> Tuple[Union[int, ArrayLike], Union[int, ArrayLike], Union[int, ArrayLike]]:
...
def index_to_ij(idx: Union[int, ArrayLike],
                n_elmt: Union[List[int], Tuple[int, ...]]) -> Tuple[Union[int, ArrayLike], Union[int, ArrayLike]]:
...
def edgeiIndex_to_ij(idx: Union[int, ArrayLike], 
                     n_cell: Union[List[int], Tuple[int, ...]],
                     n_vtx: Union[List[int], Tuple[int, ...]]) -> Tuple[Union[int, ArrayLike], Union[int, ArrayLike]]:
