...
def apply_cart_vectors(vx, vy, vz, transform_matrix):
  """
  ...
  transform_vectors_1, transform_vectors_2, transform_vectors_3 = np.dot(transform_matrix, vectors)
  
  if vx.ndim != 1 :
    transform_vectors_1 = transform_vectors_1.reshape(vx.shape, order='F')
    transform_vectors_2 = transform_vectors_2.reshape(vy.shape, order='F')
    transform_vectors_3 = transform_vectors_3.reshape(vz.shape, order='F')
   
  return transform_vectors_1, transform_vectors_2, transform_vectors_3
...
def create_transform_matrix(revolution_axis=(0, 0, 1)):  
  ...
  if revolution_axis[0] != 0:
    ...
    revolution_axis_bis = np.array([0, -revolution_axis[2]/revolution_axis[1], 1], order='F') 
  elif revolution_axis[2] != 0:
    revolution_axis_bis = np.array([1, 0, -revolution_axis[1]/revolution_axis[2]], order='F')
