...
bool init_maia_default_loggers() {
  ...
  std_e::add_logger_if_absent(std_e::logger{"maia"             ,std_e::mpi_stdout_printer{}});
  std_e::add_logger_if_absent(std_e::logger{"maia.rank_0"      ,std_e::mpi_rank_0_stdout_printer{}});
