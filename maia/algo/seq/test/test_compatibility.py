...
@pytest.fixture
def poly_tree_new():
  return PT.yaml.to_cgns_tree(
  """
  Zone Zone_t I4 [[15, 4, 0]]:
    ZoneType ZoneType_t 'Unstructured':
    NGON_n Elements_t I4 [22, 0]:
      ElementRange IndexRange_t I4 [1, 18]:
      ElementConnectivity DataArray_t:
        I4 : [1, 6, 9, 4, 6, 11, 14, 9, 3, 5, 10, 8, 8, 10, 15, 13, 1, 2, 7, 6, 2, 3, 8, 7, 6, 7, 12, 11, 7, 8, 13, 12,
              4, 9, 10, 5, 9, 14, 15, 10, 1, 4, 5, 2, 11, 12, 15, 14, 2, 5, 3, 12, 13, 15, 7, 8, 10, 2, 5, 10, 7, 6, 7,
              10, 9, 7, 10, 15, 12]
      ElementStartOffset DataArray_t I4 [0, 4, 8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48, 51, 54, 57, 61, 65, 69]:
      ParentElements DataArray_t:
        I4 : [[19, 0], [20, 0], [21, 0], [22, 0], [19, 0], [21, 0], [20, 0], [22, 0], [19, 0], [20, 0], [19, 0], [20, 0],
              [21, 0], [22, 0], [21, 22], [19, 21], [19, 20], [20, 22]]
      ParentElementsPosition DataArray_t:
        I4 : [[5, 0], [5, 0], [2, 0], [2, 0], [2, 0], [1, 0], [2, 0], [1, 0], [4, 0], [4, 0], [1, 0], [6, 0], [4, 0], [5,
              0], [5, 4], [3, 3], [6, 1], [3, 3]]
    NFACE_n Elements_t I4 [23, 0]:
      ElementRange IndexRange_t I4 [19, 22]:
      ElementConnectivity DataArray_t:
        I4 : [11, 5, 16, 9, 1, 17, -17, 7, 18, 10, 2, 12, 6, 3, -16, 13, 15, 8, 4, -18, -15, 14]
      ElementStartOffset DataArray_t I4 [0, 6, 12, 17, 22]:
  """)
...
def test_poly_new_to_old_2d(comm):
