...
def test_cgns_registry_1p(comm):
  ...
  assert list(cgr.paths(CGL.Zone_t)) == ["Base0/ZoneU2", "Base0/ZoneU1"]

  # get_global_id_from_path_and_type
  assert CGR.get_global_id_from_path_and_type(cgr, "Base0", CGL.CGNSBase_t) == 1

  assert CGR.get_global_id_from_path_and_type(cgr, "Base0/ZoneU1", CGL.Zone_t) == 2
  assert CGR.get_global_id_from_path_and_type(cgr, "Base0/ZoneU2", CGL.Zone_t) == 1
  ...
  assert CGR.get_global_id_from_path_and_type(cgr, "Base0/WALL"    , CGL.Family_t) == 1
  assert CGR.get_global_id_from_path_and_type(cgr, "Base0/FARFIELD", CGL.Family_t) == 2
  assert CGR.get_global_id_from_path_and_type(cgr, "Base0/SYM"     , CGL.Family_t) == 3

  # get_global_id_from_path_and_type
  assert CGR.get_global_id_from_path_and_type(cgr, "Base0", "CGNSBase_t") == 1

  assert CGR.get_global_id_from_path_and_type(cgr, "Base0/ZoneU1", "Zone_t") == 2
  assert CGR.get_global_id_from_path_and_type(cgr, "Base0/ZoneU2", "Zone_t") == 1
  ...
  assert CGR.get_global_id_from_path_and_type(cgr, "Base0/WALL"    , "Family_t") == 1
  assert CGR.get_global_id_from_path_and_type(cgr, "Base0/FARFIELD", "Family_t") == 2
  assert CGR.get_global_id_from_path_and_type(cgr, "Base0/SYM"     , "Family_t") == 3

  # get_path_from_global_id_and_type
  assert CGR.get_path_from_global_id_and_type(cgr, 1,  CGL.CGNSBase_t) == "Base0"

  assert CGR.get_path_from_global_id_and_type(cgr, 2, CGL.Zone_t) == "Base0/ZoneU1"
  assert CGR.get_path_from_global_id_and_type(cgr, 1, CGL.Zone_t) == "Base0/ZoneU2"
  ...
  assert CGR.get_path_from_global_id_and_type(cgr, 1, CGL.Family_t) == "Base0/WALL"
  assert CGR.get_path_from_global_id_and_type(cgr, 2, CGL.Family_t) == "Base0/FARFIELD"
  assert CGR.get_path_from_global_id_and_type(cgr, 3, CGL.Family_t) == "Base0/SYM"

  # get_path_from_global_id_and_type
  assert CGR.get_path_from_global_id_and_type(cgr, 1,  "CGNSBase_t") == "Base0"

  assert CGR.get_path_from_global_id_and_type(cgr, 2, "Zone_t") == "Base0/ZoneU1"
  assert CGR.get_path_from_global_id_and_type(cgr, 1, "Zone_t") == "Base0/ZoneU2"
  ...
  assert CGR.get_path_from_global_id_and_type(cgr, 1, "Family_t") == "Base0/WALL"
  assert CGR.get_path_from_global_id_and_type(cgr, 2, "Family_t") == "Base0/FARFIELD"
  assert CGR.get_path_from_global_id_and_type(cgr, 3, "Family_t") == "Base0/SYM"
...
def test_add_cgns_registry_information_1p(comm):
  ...
  assert PT.get_value(zone1_id_n) == 2
  assert PT.get_value(zone2_id_n) == 1
...
def test_add_cgns_registry_information_2p(comm):
  ...
  if comm.Get_rank()==0:
    assert PT.get_value(PT.get_node_from_path(tree, "Base0/ZoneU1/:CGNS#Registry")) == 2
  if comm.Get_rank()==1:
    assert PT.get_value(PT.get_node_from_path(tree, "Base0/ZoneU2/:CGNS#Registry")) == 1
