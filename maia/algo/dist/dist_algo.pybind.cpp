...
#include "maia/algo/dist/merge_by_elt_type/merge_by_elt_type.hpp"
...
const auto std_elements_to_ngons               = apply_cpp_cgns_par_function_to_py_base(maia::std_elements_to_ngons);
