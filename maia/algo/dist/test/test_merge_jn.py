...
def test_update_ngon(comm):
  ...
  expected_pe_full = np.array([[35,0],[36,0],[37,0],[38,0],[39,35],[40,36],[41,37],[42,38],[39,0],[40,0],[41,0],[42,0],
                               [35,0],[37,0],[39,41],[36,35],[38,37],[40,39],[42,41],[36,0],[38,0],[40,42],[35,0],[39,0],
                               [36,0],[40,0],[37,35],[41,39],[38,36],[42,40],[37,0],[41,0],[38,0],[42,0]])
  expected_ec_full = np.array([ 1, 4, 5, 2,  2, 5, 6, 3,  4, 7, 8, 5,  5, 8, 9, 6, 10,12,11, 9,  9,11,13,11,
                               12,14,13,11, 11,13,15,13, 15,17,18,16, 17,19,17,15, 17,19,20,18, 19,21,19,17,
                               10,12, 4, 1, 12,14, 7, 4, 16,18,12,10,  9,11, 5, 2, 11,13, 8, 5, 15,17,11, 9,
                               17,19,13,11,  3, 6,13,11,  6, 9,15,13, 11,13,19,17,  1, 2, 9,10, 10, 9,15,16, 
                                2, 3,11, 9,  9,11,17,15,  4, 5,11,12, 12,11,17,18,  5, 6,13,11, 11,13,19,17,
                               14,13, 8, 7, 20,19,13,14, 13,15, 9, 8, 19,21,15,13])
