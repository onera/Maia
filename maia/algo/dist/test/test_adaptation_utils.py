...
def test_elmt_pl_to_vtx_pl(comm):
  ...
  quad_n = PT.get_child_from_predicate(zone, PT.pred.is_elmt_of_type('QUAD_4'))
...
def test_is_elt_included(comm):
  ...
  tri_elt   = PT.get_node_from_predicate(zone, PT.pred.is_elmt_of_type('TRI_3'))
  tetra_elt = PT.get_node_from_predicate(zone, PT.pred.is_elmt_of_type('TETRA_4'))
...
def test_add_undefined_faces(comm):
  ...
  tet_n = PT.get_child_from_predicate(zone, PT.pred.is_elmt_of_type('TETRA_4'))
  tri_n = PT.get_child_from_predicate(zone, PT.pred.is_elmt_of_type('TRI_3'))
