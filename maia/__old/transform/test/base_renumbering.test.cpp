...
TEST_CASE("base renumbering") {
  ...
  auto z0_coordX = view_as_span<R8>(value(z0_coordX_node));
  auto z0_coordY = view_as_span<R8>(value(z0_coordY_node));
  auto z0_coordZ = view_as_span<R8>(value(z0_coordZ_node));
  ...
  auto z0_inflow_pl = view_as_span<I4>(value(z0_inflow_pl_node));
  ...
  auto z0_grid_connec_pl = view_as_span<I4>(value(z0_grid_connec_pl_node));
  tree& z0_grid_connec_pld_node = get_node_by_matching(z0,"ZoneGridConnectivity/MixingPlane/PointListDonor");
  auto z0_grid_connec_pld = view_as_span<I4>(value(z0_grid_connec_pld_node));
