...
inv_permute_parent_elements_sub(cgns::md_array_view<I,2>& parent_elts, const std::vector<I>& permutation, I offset, I n) -> void {
  auto inv_p = std_e::inverse_permutation(permutation);
  std_e::offset_permutation op(offset,inv_p);
  auto in_inter = [offset,n](I pe){ return pe!=0 && offset <= pe && pe < offset+n; };
