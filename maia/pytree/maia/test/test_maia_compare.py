...
from maia.pytree.maia.compare import field_comparison, tensor_field_comparison
...
"""
  ...
  is_ok, err_report, warn_report = PT.diff_tree(t, t_ref, comp = field_comparison(1.e-12, MPI.COMM_SELF))
  assert not is_ok
  ...
  is_ok, err_report, warn_report = PT.diff_tree(t, t_ref, comp = tensor_field_comparison(1.e-12, MPI.COMM_SELF))
  assert not is_ok
