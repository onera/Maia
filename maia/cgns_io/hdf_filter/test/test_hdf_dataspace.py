from maia.cgns_io.hdf_filter import hdf_dataspace
...
def test_create_data_array_filter():
  ...
  assert hdf_dataspace.create_data_array_filter([0,10,100], [1,100]) == \
      hdf_dataspace.create_pointlist_dataspace([0,10,100])
