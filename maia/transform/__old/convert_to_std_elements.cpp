...
//    throw;
//    std::vector<I4> tmp_fix;
//    auto ngon_accessor = std_e::view_as_vblock_range(homogenous_range,tmp_fix); // TODO!!!
...
//    //  auto tris = std_e::view_as_block_range<3>(homogenous_connectivities);
...
//    //  auto quads = std_e::view_as_block_range<4>(homogenous_connectivities);
...
//  auto nface_eso_start = nface_eso.data();
...
//
//  auto tetra_eso = std_e::make_span(nface_eso_start+polyhedron_type_starts[0],nface_eso_start+polyhedron_type_starts[1]);
//  auto pyra_eso  = std_e::make_span(nface_eso_start+polyhedron_type_starts[1],nface_eso_start+polyhedron_type_starts[2]);
//  auto penta_eso = std_e::make_span(nface_eso_start+polyhedron_type_starts[2],nface_eso_start+polyhedron_type_starts[3]);
//  auto hexa_eso  = std_e::make_span(nface_eso_start+polyhedron_type_starts[3],nface_eso_start+polyhedron_type_starts[4]);
//  auto tetra_range = std_e::make_span(nface_start+nface_eso[polyhedron_type_starts[0]],nface_start+nface_eso[polyhedron_type_starts[1]]);
//  auto pyra_range  = std_e::make_span(nface_start+nface_eso[polyhedron_type_starts[1]],nface_start+nface_eso[polyhedron_type_starts[2]]);
//  auto penta_range = std_e::make_span(nface_start+nface_eso[polyhedron_type_starts[2]],nface_start+nface_eso[polyhedron_type_starts[3]]);
//  auto hexa_range  = std_e::make_span(nface_start+nface_eso[polyhedron_type_starts[3]],nface_start+nface_eso[polyhedron_type_starts[4]]);
//
//  // debug
//  auto nfs = std_e::view_as_vblock_range(nface_connectivity,nface_eso);
//  auto first_ngon_id = ElementRange<I4>(ngons)[0];
...
//  auto tetra_accessor = std_e::view_as_vblock_range(tetra_range,tetra_eso);
...
//  }
//
//  auto pyra_accessor = std_e::view_as_vblock_range(pyra_range,pyra_eso);
...
//  }
//
//  auto penta_accessor = std_e::view_as_vblock_range(penta_range,penta_eso);
...
//  }
//
//  auto hexa_accessor = std_e::view_as_vblock_range(hexa_range,hexa_eso);
