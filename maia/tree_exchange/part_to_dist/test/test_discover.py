...
Zone.P2.N1 Zone_t:
  ...
  def test_simple(self, sub_comm):
    ...
    dist_zone = I.newZone('Zone')
    disc.discover_nodes_of_kind(dist_zone, I.getZones(part_tree), [CGL.ZoneBC_t, CGL.BC_t], sub_comm)
    assert (I.getType(I.getNodeFromPath(dist_zone, 'ZBC/BCA')) == "BC_t")
    assert (I.getType(I.getNodeFromPath(dist_zone, 'ZBC/BCB')) == "BC_t")

    dist_zone = I.newZone('Zone')
    disc.discover_nodes_of_kind(dist_zone, I.getZones(part_tree), [CGL.ZoneBC_t, 'BC_t'], sub_comm)
    assert (I.getType(I.getNodeFromPath(dist_zone, 'ZBC/BCA')) == "BC_t")
    assert (I.getType(I.getNodeFromPath(dist_zone, 'ZBC/BCB')) == "BC_t")
