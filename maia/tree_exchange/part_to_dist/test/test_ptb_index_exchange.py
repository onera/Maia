...
Zone.P0.N0 Zone_t:
  ...
  """.format(dtype)
    ...
    expected_pe = np.array([[1,0], [2,0], [3,0], [4,0], [1,5], [2,6],
                            [3,7], [4,8], [5,0], [6,0], [7,0], [8,0]])
    expected_pe += 36 * (expected_pe > 0)
  elif rank == 1:
    yt = ""
    expected_pe = np.array([[1,0], [3,0], [5,0], [7,0], [1,2], [3,4],
...
Zone.P2.N1 Zone_t:
  ...
  """.format(dtype)
    expected_pe = np.array([[1,0], [5,0], [2,0], [6,0], [1,3], [5,7],
