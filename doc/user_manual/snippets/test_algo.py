...
def test_find_joins_donor_name():
  #find_joins_donor_name@start
  import mpi4py.MPI as MPI
  import maia
  import maia.pytree as PT
  from   maia.utils.test_utils import mesh_dir
...
def test_enforce_symmetric_joins():
  #enforce_symmetric_joins@start
  import mpi4py.MPI as MPI
  import maia
  import maia.pytree as PT
  from   maia.utils.test_utils import mesh_dir
  ...
  dist_tree = maia.io.file_to_dist_tree(mesh_dir/'H_elt_and_s.yaml', MPI.COMM_WORLD)
  maia.algo.dist.enforce_symmetric_joins(dist_tree, MPI.COMM_WORLD)
