...
def test_change_basis(zonetype, revolution_axis, comm):
...
def test_cartesian_to_cylinder(zonetype, revolution_axis, comm): 
  ...
  radius = PT.get_node_from_predicates(part_tree, 'CGNSBase_t/Zone_t/GridCoordinatesCyl/CoordinateR')[1]
  theta = PT.get_node_from_predicates(part_tree, 'CGNSBase_t/Zone_t/GridCoordinatesCyl/CoordinateTheta')[1]

  if comm.size == 1:
    radius_ref = [0., 0.25, 0.5, 0.5, 0.25, 0., 1., 0.75, 0.5, 1.25, 1.27475488, 1.3462912,
                  1.3462912, 1.27475488, 1.25, 1.60078106, 1.45773797, 1.3462912, 2.5,
                  2.51246891, 2.54950976, 2.54950976, 2.51246891, 2.5, 2.6925824,  2.61007663, 2.54950976]
    theta_ref  = [0., 3.14159265, 3.14159265, 0., 0., 0., 0., 0., 0., 1.57079633, 1.76819189, 1.9513027,
                  1.19028995, 1.37340077, 1.57079633, 0.89605538, 1.03037683, 1.19028995, 1.57079633, 
                  1.67046498, 1.76819189, 1.37340077, 1.47112767, 1.57079633, 1.19028995, 1.27933953, 1.37340077]
  elif comm.size == 2:
     if comm.rank == 0:
        radius_ref = [0., 0.25, 0.5, 0.25, 1., 0.75, 1.25, 1.27475488, 1.3462912, 1.27475488, 1.60078106, 
                      1.45773797, 2.5, 2.51246891, 2.54950976, 2.51246891, 2.6925824, 2.61007663]
        theta_ref =  [0., 3.14159265, 0., 0., 0., 0., 1.57079633, 1.76819189, 1.19028995, 1.37340077, 0.89605538,
                       1.03037683, 1.57079633, 1.67046498, 1.37340077, 1.47112767, 1.19028995, 1.27933953]
     elif comm.rank == 1:
        radius_ref = [0.25, 0.5, 0.25, 0., 0.75, 0.5, 1.27475488, 1.3462912,  1.27475488, 1.25, 1.45773797,
                      1.3462912, 2.51246891, 2.54950976, 2.51246891, 2.5, 2.61007663, 2.54950976]
        theta_ref = [3.14159265, 3.14159265, 0., 0., 0., 0.,  1.76819189, 1.9513027, 1.37340077, 1.57079633,
                     1.03037683, 1.19028995, 1.67046498, 1.76819189, 1.47112767, 1.57079633, 1.27933953, 1.37340077]
  
  assert np.allclose(radius.flatten(order='F'), radius_ref)
  assert np.allclose(theta.flatten(order='F'), theta_ref)

def test_cylinder_to_cartesian(zonetype, revolution_axis, comm): 
