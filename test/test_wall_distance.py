...
def test_wall_distance_S(comm, write_output):
  ...
  maia.algo.compute_wall_distance(dist_tree, comm)
...
def test_wall_distance_U(comm, write_output):
  ...
  perio = (comm.size == 3)
  maia.algo.compute_wall_distance(part_tree, comm, perio=perio)
